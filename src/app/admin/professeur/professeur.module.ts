...
import { FormDialogComponent } from './toutprofesseur/dialogs/form-dialog/form-dialog.component';
...
import { ProfesseurService } from './toutprofesseur/professeur.service';


@NgModule({
  declarations: [
    ToutprofesseurComponent,
    FormDialogComponent
  ],
  imports: [
    CommonModule,
